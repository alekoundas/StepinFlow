...
//   // Clean previous handler if exists
//   try {
//     ipcMain.removeHandler(IPC_CHANNELS.BACKEND_SEND);
//     console.log(
//       "[BackendHandler] =============   Previous handler removed   =============",
//     );
//   } catch {}
...
//       try {
//         return await invokeBackend(msg.action, msg.payload);
//       } catch (err: any) {
//         log.error(`Backend call failed [${msg.action}]:`, err.message);
//         throw err;
//       }
//     },
//   );

//   console.log("[BackendHandler] IPC Handler 'BACKEND_SEND' registered");
...
//     if (!client?.writable) {
//       throw new Error(
//         "[BackendHandler]: Backend pipe not available — reconnecting, please retry",
//       );
//     }
...
//     console.error("[Broadcast]: ", plain.type);
