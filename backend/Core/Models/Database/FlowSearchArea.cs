...
namespace Core.Models.Database
{
    ...
    public class FlowSearchArea : BaseDbModel
    {
        ...
        // CUSTOM
        public int? ParentFlowSearchAreaId { get; set; }
        public FlowSearchArea? ParentFlowSearchArea { get; set; }
        ...
        public IEnumerable<FlowSearchArea> ChildFlowSearchAreas { get; set; } = [];
        public IEnumerable<FlowLocation> FlowLocations { get; set; } = [];
