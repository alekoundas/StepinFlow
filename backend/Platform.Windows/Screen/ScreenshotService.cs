...
namespace Platform.Windows.Screen
{
    public sealed class ScreenshotService : IScreenshotService
    {
        ...
        public ScreenshotService(IWindowsGraphicsCaptureService windowsGraphicsCaptureService, IWindowService windowService)
        {
        ...
        {
            byte[] result = [];
            IntPtr hMon = ScreenMetrics.FindHMonitorById(deviceName);
        ...
        public byte[] CaptureVirtualScreen(ScreenshotFormatEnum screenshotFormat, int jpegQuality)
        {
            ...
            Rectangle rect = ScreenMetrics.GetVirtualScreenBounds();
            using Bitmap bmp = CaptureGraphics(rect, screenshotFormat, jpegQuality);
        ...
        {
            List<MonitorInfo> monitors = ScreenMetrics.GetAllMonitors()
            ...
            Rectangle virtualBounds = ScreenMetrics.GetVirtualScreenBounds();
