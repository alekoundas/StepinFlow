...
namespace DataAccess.Migrations
{
    ...
    [Migration("20260924115537_TemplateOwnAccuracy")]
    partial class TemplateOwnAccuracy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.Database.Flow", b =>
                {
                    ...
                    b.Property<int?>("AppUnderTestAreaId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Core.Models.Database.FlowCsvColumn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Core.Models.Database.FlowStep", b =>
                {
                    ...
                    b.Property<bool>("EndExecutionAsSuccess")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("RunCommandValue")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Core.Models.Database.FlowStepLastGoodScreenshotHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("FlowStepId", "ViewportWidth", "ViewportHeight")
                        .IsUnique();

                    b.ToTable("FlowStepLastGoodScreenshotHistories");
                });

            modelBuilder.Entity("Core.Models.Database.FlowStepTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("AuthoredDpi")
                        .HasColumnType("INTEGER");

                    b.Property<int>("AuthoredFlowAreaHeight")
                        .HasColumnType("INTEGER");

                    b.Property<int>("AuthoredFlowAreaWidth")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("FlowStepTemplates");
                });

            modelBuilder.Entity("Core.Models.Database.FlowViewport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Core.Models.Database.Flow", b =>
                {
                    b.HasOne("Core.Models.Database.FlowArea", "AppUnderTestArea")
                        .WithMany()
                        .HasForeignKey("AppUnderTestAreaId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.Navigation("AppUnderTestArea");
                });
            ...
            modelBuilder.Entity("Core.Models.Database.FlowStep", b =>
                {
                    ...
                    b.HasOne("Core.Models.Database.Flow", "SubFlow")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Models.Database.FlowStepLastGoodScreenshotHistory", b =>
                {
                    b.HasOne("Core.Models.Database.FlowStep", "FlowStep")
                        .WithMany("FlowStepLastGoodScreenshotHistories")
                        .HasForeignKey("FlowStepId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Models.Database.Flow", b =>
                {
                    ...
                    b.Navigation("FlowCsvColumns");

                    b.Navigation("FlowPoints");

                    b.Navigation("FlowSteps");

                    b.Navigation("FlowViewports");
                });
            ...
            modelBuilder.Entity("Core.Models.Database.FlowStep", b =>
                {
                    ...
                    b.Navigation("FlowStepLastGoodScreenshotHistories");

                    b.Navigation("FlowStepReferences");

                    b.Navigation("FlowStepReferencesEnd");

                    b.Navigation("FlowStepTemplates");
                });
