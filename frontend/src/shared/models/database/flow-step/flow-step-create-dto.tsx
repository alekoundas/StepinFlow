...
export class FlowStepCreateDto {
  ...
  parentFlowStep?: FlowStepCreateDto;

  // General FlowStep reference for multiple types
  flowStepReferenceId?: number;
  flowStepReference?: FlowStepCreateDto;

  // Navigation collections
  // childrenFlowSteps: FlowStepCreateDto[] = [];
  // flowStepReferences: FlowStepCreateDto[] = [];
  flowStepImages: FlowStepImageCreateDto[] = [];

  constructor(data: Partial<FlowStepCreateDto> = {}) {
    Object.assign(this, {
      ...data,
    });
  }
